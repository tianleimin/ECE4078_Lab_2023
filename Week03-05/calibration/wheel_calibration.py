...
import os
import sys
sys.path.insert(0, r"C:\Users\thinu\Documents\ECE5178_IntelligentRobotics\Labs\M2\ECE4078_Lab_2023-main_M2\ECE4078_Lab_2023-main\Week03-05\util")
...
def calibrateBaseline(scale):
    ...
    for delta_time, wheel_vel in zip(delta_times, wheel_velocities_range):
        ...
        baseline += scale * delta_time * 2 * wheel_vel / (2*np.pi)
